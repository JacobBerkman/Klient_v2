...
export const routes = {
  ...
  submissionSectionItems: (submissionId, sectionKey) => joinPath(API_PREFIX, 'forms', 'submissions', submissionId, 'sections', sectionKey, 'items'),
  submissionSectionItem: (submissionId, sectionKey, itemKey) => joinPath(API_PREFIX, 'forms', 'submissions', submissionId, 'sections', sectionKey, 'items', itemKey),
