...
test('draft collaborator messaging uses compact role hints and disabled-control reasons', () => {
  assert.match(appJs, /function collaboratorDisabledReason\(/)
  assert.match(appJs, /Readonly role cannot add collaborators\./)
  assert.match(appJs, /Only the draft owner or an admin can add collaborators\./)
  assert.match(appJs, /class="collaborator-status-row"/)
  assert.match(appJs, /Role: \$\{escapeHtml\(currentUserRole\)\}/)
  assert.match(appJs, /class="muted compact collaborator-action-hint"/)
  assert.match(appJs, /class="muted compact disabled-control-reason"/)
  assert.match(appJs, /aria-describedby="\$\{!canManage \? `add-reason-\$\{draft.id\}` : ''\}"/)
...
test('styles provide visible focus indicators and empty-state affordances', () => {
  ...
  assert.match(styles, /\.collaborator-status-row \{/)
  assert.match(styles, /\.disabled-control-reason \{/)
  assert.match(styles, /\.collaborator-recovery-hint \{/)
