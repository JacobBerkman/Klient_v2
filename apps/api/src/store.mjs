...
import { createUploadPrimitives } from './store/uploads-shared.mjs'
import { createPortalDomain } from './store/portal-domain.mjs'
import { createUploadsDomain } from './store/uploads-domain.mjs'
...
export function createStore({
  ...
  const portalDomain = createPortalDomain({
    state,
    persist,
    objectStorage,
    createUploadIntent,
